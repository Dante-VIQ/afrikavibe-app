                    ...
                    <div class="col-lg-12">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="card-title card-title-dash">Todo
                                list</h4>
                            <div x-data="{ show: false }" class="add-items d-flex mb-0" x-cloak>
                                ...
                                <div x-show="show" @click.outside.prevent='show = false'>
                                    <form wire:submit.prevent="create">
                                        ...
                                        <div class="flex space-x-2">
                                            ...
                                            <div class="mb-6 text-black font-semibold">
                                                <label for="due" class="inline-block text-lg mb-2">due</label>
                                                <input wire:model="due" type="datetime"
                                                    class="border border-gray-200 rounded p-2 w-full" name="detail"
                                                    value="{{ old('due') }}" />
                        ...
                        <div class="list-wrapper">
                            <ul class="todo-list todo-list-rounded">
                                ...
                                @foreach ($todos as $todo)
                                        <li class="d-block pb-4">
                                            <div class="form-check w-100">
                                                <label class="form-check-label">
                                                    <input class="checkbox" type="checkbox">{{ $todo->name }} <i
                                    ...
                                    @endforeach
                                {{-- @else
                                    <p class="text-center bg-gray-200 text-black">No Tasks for now!</p>
                                @endunless --}}
                                {{-- <li class="d-block">
                                    <div class="form-check w-100">
                                        <label
