<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link wire:click="$emit('navigateTo', 'destination')" href="destination" :active="request()->routeIs('destination')">
                        {{ __('Destinations') }}
                    </x-nav-link>
                ...
                @auth
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <!-- Authentication -->
                            <button href="{{ route('logout') }}" @click.prevent="$root.submit();" class="w-full text-start">
                                <x-dropdown-link>
                                    {{ __('Log Out') }}
                                </x-dropdown-link>
                            </button>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link wire:click="$emit('navigateTo', 'dashboard')" href="/dashboard">
                {{ __('Dashboard') }}
        ...
        {{-- <div class="flex flex-col h-full p-3 w-60 dark:bg-gray-200 dark:text-gray-800">
            <div class="space-y-3">
                <div class="relative">
                ...
                <div class="flex-1">
                    <ul class="pt-2 pb-4 space-y-1 text-sm">
                        ...
                        <li class="rounded-sm dark:bg-gray-100 dark:text-gray-900">
                            <a rel="noopener noreferrer" href="#"
                                class="flex items-center p-2 space-x-3 rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                    class="w-5 h-5 fill-current dark:text-gray-600">
            ...
            <div class="flex items-center p-2 mt-12 space-x-4 justify-self-end">
                ...
                <div>
                    ...
                    <span class="flex items-center space-x-1">
                        <a rel="noopener noreferrer" href="#"
                            class="text-xs hover:underline dark:text-gray-600">View profile</a>
                    </span>
                </div>
            </div>
        </div> --}}
