...
<body class="font-serif single is-preload">
    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <!-- Cutlery -->
        <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-1920954764751411"
            data-ad-slot="3863684113" data-ad-format="auto" data-full-width-responsive="true"></ins>
        <script>
            (adsbygoogle = window.adsbygoogle || []).push({});
        </script>
        	<script src="{{ asset('read/js/jquery.min.js') }}"></script>
			<script src="{{ asset('read/js/browser.min.js') }}"></script>
			<script src="{{ asset('read/js/breakpoints.min.js') }}"></script>
			<script src="{{ asset('read/js/util.js') }}"></script>
			<script src="{{ asset('read/js/main.js') }}"></script>
