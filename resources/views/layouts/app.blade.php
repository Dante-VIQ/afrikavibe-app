...
<head>
    ...
    <link rel="preload" href="{{ asset('/resources/css/output.css') }}" rel="stylesheet">
    <link rel="preload" href="{{ asset('./fontawesome6/css/all.min.css') }}" rel="stylesheet">
...
<body class="font-mono">
    ...
    <!-- Additional Scripts -->
    {{-- <script type="module" src="{{ asset('/bootstrap5/js/bootstrap.min.js') }}" defer></script> --}}
    ...
    <script type="module" src="{{ asset('/public/jquery.mobile-1.4.5/jquery.mobile-1.4.5.min.js') }}" defer></script>
